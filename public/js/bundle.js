...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWVoZWRpaXNsYW1yaXBvbiIsImEiOiJja21kbWF6aTIybmN3MnZxcjVjNjV5cTUxIn0.zpYgEDyfzZ6V7HgeLWvT_w';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mehediislamripon/cko18nhlv0mon17l6j2jf2fb9' // center: [-118.113491, 34.111745],
    // zoom: 10,
    // interactive: false,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signup is successfully! Wait for a while.....');
              location.replace('/me');
            }
...
var stripe = Stripe('pk_test_51ImxR8SE7SzMFgj1GZwZ33stT6wkMVPNnJQpyd5xXHRys5OBUs5IuncsplrIbVPjgosPoDN1uekoYxh5lbhszFxB00aOac3EAi'); // pk_test_51ImxR8SE7SzMFgj1GZwZ33stT6wkMVPNnJQpyd5xXHRys5OBUs5IuncsplrIbVPjgosPoDN1uekoYxh5lbhszFxB00aOac3EAi
...
var signUpForm = document.getElementById('signUpForm'); // DELEGATION
...
if (signUpForm) {
  signUpForm.addEventListener('submit', function (e) {
    ...
    var passwordConfirm = document.getElementById('passwordConfirm').value; // const data = {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "3665" + '/');
